...
class main1 extends CI_Controller {
	...
	public function stexam()
	{
		$this->load->view('stexam');
	...
	public function login()
	{
		...
		if($this->form_validation->run())
		{
			...
			$a=$this->mainmodel1->login($email,$password);
			if($a)
			{
			$id=$this->mainmodel1->getuserid($email);
	...
	{
		redirect(base_url().'main/loginexam');	
	}
}
